...
I bridge the gap between security theory and real-world threats. As **Co-Founder & CEO of CoDe R.T.D.**, I lead digital content protection initiatives while teaching the next generation of security professionals at **Galileo Galilei** and **Forte Chance ETS**.

My approach is simple: **understand how systems break to build them unbreakable.**

### 🎯 Current Focus

- 🔐 **Offensive Security & Penetration Testing** — Mastering real-world exploitation techniques
- ☁️ **Cloud Security Architecture** — Designing resilient AWS/Azure/GCP infrastructures
- 🤖 **AI Security & Defense** — Securing LLMs, ML pipelines, and emerging AI threats
- 📚 **Knowledge Sharing** — Mentoring cybersecurity professionals and publishing writeups
...
> "Cybersecurity isn't a destination — it's a constant conversation between attack and defense."

I believe in **practical, hands-on security**. Theory matters, but exploitation is the ultimate teacher. Every vulnerability found is a lesson learned, every system secured is a small victory in an endless war.
